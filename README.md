...
Repos marked with `[fork]` are forks of upstream projects I have contributed to.
...
| [incubator-airflow](https://github.com/delijati/incubator-airflow) | fork | `Python` `Apache Airflow` | Apache Airflow (Incubating) -- workflow scheduler and orchestrator. |
| [s3fs](https://github.com/delijati/s3fs) | fork | `Python` `AWS S3` | S3 filesystem interface for Python. |
...
| [kaggle-web-traffic](https://github.com/delijati/kaggle-web-traffic) | fork | `Jupyter Notebook` `Kaggle` | 1st place solution for the Kaggle web traffic forecasting competition. |
| [KaggleTextNormalization](https://github.com/delijati/KaggleTextNormalization) | fork | `Python` `Kaggle` `NLP` | Kaggle text normalization challenge. |
| [TensorFlow-Examples](https://github.com/delijati/TensorFlow-Examples) | fork | `Jupyter Notebook` `TensorFlow` | TensorFlow tutorial and examples for beginners. |
| [ggml](https://github.com/delijati/ggml) | fork | `C` `ML` | Tensor library for machine learning (llama.cpp backend). |
| [krishnamurti-clone](https://github.com/delijati/krishnamurti-clone) | fork | `AI` `LLM` | An AI clone of Jiddu Krishnamurti. |
...
| [pysimiam](https://github.com/delijati/pysimiam) | fork | `Python` `Robotics` | A Python Sim.I.Am port -- robot simulation framework from GA Tech. |
...
| [quickbot_local](https://github.com/delijati/quickbot_local) | fork | `Python` `Robotics` | Local computer interface for controlling the QuickBot. |
| [qb_test](https://github.com/delijati/qb_test) | fork | `Python` `Robotics` | Tests for QuickBot motors, IR sensors and wheel encoders. |
| [drone-fq777-954](https://github.com/delijati/drone-fq777-954) | fork | `Python` `Drone` `WiFi` | Python code for controlling the FQ777-954 drone over WiFi. |
| [fq777-954-chrome-app](https://github.com/delijati/fq777-954-chrome-app) | fork | `JavaScript` `Drone` | Chrome app for controlling the FQ777-954 drone. |
...
| [pyinstaller-hooks-contrib](https://github.com/delijati/pyinstaller-hooks-contrib) | fork | `Python` `Packaging` | Community-maintained hooks for PyInstaller. |
...
| [python-dotenv](https://github.com/delijati/python-dotenv) | fork | `Python` | Get and set values in .env files for local and production servers. |
...
| [matrix-python-sdk](https://github.com/delijati/matrix-python-sdk) | fork | `Python` `Matrix` | Matrix Client-Server SDK for Python 2 and 3. |
| [history-service](https://github.com/delijati/history-service) | fork | `C++` `Ubuntu Touch` | History service for Ubuntu Touch. |
| [node-qwebchannel](https://github.com/delijati/node-qwebchannel) | fork | `JavaScript` `Qt` `Node.js` | Integrates Node.js and Qt WebChannel. |
...
| [yunit](https://github.com/delijati/yunit) | fork | `QML` `Ubuntu Touch` | User interface shell based on the Unity 8 shell. |
| [webbrowser-app](https://github.com/delijati/webbrowser-app) | fork | `QML` `Ubuntu Touch` | Web browser app for Ubuntu Touch. |
...
| [unity8-desktop-install-tools](https://github.com/delijati/unity8-desktop-install-tools) | fork | `Shell` `Unity8` | Tools for installing Unity 8 on desktop. |
| [docs](https://github.com/delijati/docs) | fork | `Python` `Halium` | Documentation for the Halium project. |
| [pyprovision-uc](https://github.com/delijati/pyprovision-uc) | fork | `Python` `Ubuntu Touch` | Unicorn-Engine powered alternative provisioning tool for Ubuntu Touch. |
| [python-adb](https://github.com/delijati/python-adb) | fork | `Python` `ADB` | Python ADB + Fastboot implementation. |
...
| [aiohttp](https://github.com/delijati/aiohttp) | fork | `Python` `asyncio` | Async HTTP client/server framework (asyncio). |
...
| [f5vpn](https://github.com/delijati/f5vpn) | fork | `Python` `VPN` | F5 VPN client utilities. |
| [rhapsody2plantuml](https://github.com/delijati/rhapsody2plantuml) | fork | `Python` `PlantUML` `UML` | Convert IBM Rhapsody diagrams to PlantUML format. |
| [Luminea-WiFi-Power-Outlet](https://github.com/delijati/Luminea-WiFi-Power-Outlet) | fork | `Python` `IoT` | Flash/control Luminea WiFi Power Outlet. |
...
| Repository | Type | Tech | Description |
|---|---|---|---|
| [cornice](https://github.com/delijati/cornice) | fork | `Python` `Pyramid` `REST` | RESTful services for Pyramid. |
...
| [fastapi-cloudauth](https://github.com/delijati/fastapi-cloudauth) | fork | `Python` `FastAPI` `Auth` | Simple integration between FastAPI and cloud auth services (Cognito, Auth0). |
...
| [starlette-session](https://github.com/delijati/starlette-session) | fork | `Python` `Starlette` | Server-side session middleware for Starlette. |
...
| [todomvc](https://github.com/delijati/todomvc) | fork | `JavaScript` `MV*` | Todo apps for Backbone.js, Ember.js, AngularJS, and more. |
| [nock](https://github.com/delijati/nock) | fork | `JavaScript` `Testing` | HTTP mocking and expectations library for Node.js. |
| [js.underscore](https://github.com/delijati/js.underscore) | fork | `JavaScript` `Fanstatic` | Fanstatic packaging of underscore.js. |
| [js.backbone](https://github.com/delijati/js.backbone) | fork | `JavaScript` `Fanstatic` | Fanstatic packaging of Backbone.js. |
| [FlashWavRecorder](https://github.com/delijati/FlashWavRecorder) | fork | `ActionScript` `Flash` | Simple Flash file for recording audio and saving as WAV. |
