...
| Repository | Tech | Description |
|---|---|---|
| [docker-shiv](https://github.com/delijati/docker-shiv) | `Docker` `Shell` `Python` `Wine` `Shiv` | Build self-contained Python zipapps (shiv) for Windows using Docker + Wine. |
| [docker-arm-x86](https://github.com/delijati/docker-arm-x86) | `Docker` `QEMU` | Run ARM Docker images on an x86 host via QEMU emulation. |
...
| Repository | Tech | Description |
|---|---|---|
| [vim-importmagic](https://github.com/delijati/vim-importmagic) | `Python` `Vim` | Vim plugin that uses importmagic to auto-import missing Python modules. |
| [vim-buivir](https://github.com/delijati/vim-buivir) | `Python` `Vim` `virtualenv` `buildout` | Vim plugin to activate a buildout or virtualenv environment from within Vim. |
| [vimeval](https://github.com/delijati/vimeval) | `Python` `Vim` | Evaluate Python expressions directly inside Vim. |
| [benchmark](https://github.com/delijati/benchmark) | `Python` `Zappa` `WSGI` `ASGI` | Benchmark comparing WSGI vs ASGI performance under Zappa on AWS Lambda. |
| [kinto_swagger](https://github.com/delijati/kinto_swagger) | `Python` `Kinto` `Swagger` `REST` | Swagger / OpenAPI integration plugin for the Kinto storage service. |
| [cookiecutter-cornice_swagger](https://github.com/delijati/cookiecutter-cornice_swagger) | `Python` `Cookiecutter` `Cornice` `Swagger` | Cookiecutter template for quickly bootstrapping a Cornice + Swagger API. |
...
| Repository | Tech | Description |
|---|---|---|
| [crabstore](https://github.com/delijati/crabstore) | `JavaScript` `Ionic` `Protocol Buffers` | Google Play Store client written in JavaScript using the Ionic framework. |
| [js.select2](https://github.com/delijati/js.select2) | `JavaScript` `Fanstatic` | Packages the Select2 jQuery plugin as a Fanstatic resource for Python web apps. |
